                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            {{-- <div class="ml-3 relative"> --}}
                                <x-jet-dropdown align="right">
                                    ...
                                    <x-slot name="content">
                                        <x-jet-dropdown-link href="{{ route('dashboard.brand.index') }}">
                                            {{ __('Brands') }}
                                        </x-jet-dropdown-link>
                                        <div class="border-t border-gray-100"></div>
                                        <x-jet-dropdown-link href="{{ route('dashboard.category.index') }}">
                                            {{ __('Categories') }}
                                        </x-jet-dropdown-link>
                                        <div class="border-t border-gray-100"></div>
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            {{-- <div class="ml-3 relative"> --}}
                                <x-jet-dropdown align="right">
                                    ...
                                    <x-slot name="content">
                                        <x-jet-dropdown-link href="{{ route('dashboard.photogallery.index') }}">
                                            {{ __('Photo Galleries') }}
                                        </x-jet-dropdown-link>
                                        <div class="border-t border-gray-100"></div>
                                        <x-jet-dropdown-link href="{{ route('dashboard.blog.index') }}">
                                            {{ __('Blogs') }}
                                        </x-jet-dropdown-link>
                                        <div class="border-t border-gray-100"></div>
                                        <x-jet-dropdown-link href="{{ route('dashboard.product.index') }}">
