...
!(function (t) {
    ...
    var a = {
      init: function (o) {
        ...
        return e || !(o.browser.length > 0) || (e && this.length)
          ? (a.optionCheck.call(this, o) &&
            ...
            this.each(function () {
              ...
              s.data(n) ||
                ...
                l.on("unload." + n, function () {}),
                r.on("click." + n, o.linkElement, function (n) {
                  n.preventDefault();
                  var i = t(this),
                    o = i.attr("href");
                  2 === n.which ||
      ...
      in: function () {
        var i = this,
          ...
          c = o.data(n).outClass;
        e.loading && a.removeLoading.call(i),
          c && o.removeClass(c),
          u ? a.inOverlay.call(i, d, r) : a.inDefault.call(i, d, r);
      },
    ...
    (t.fn.animateCallback = function (n) {
      ...
      (t.fn.animsition = function (i) {
        return a[i]
          ? a[i].apply(this, Array.prototype.slice.call(arguments, 1))
          : "object" != typeof i && i
          ? void t.error("Method " + i + " does not exist on jQuery." + n)
